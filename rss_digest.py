...
FEEDS = [
    ...
    ("Gary Marcus", "https://garymarcus.substack.com/feed/"), Stoller", "https://www.thebignewsletter.com/feed/"),
...
def generate_digest(articles):
    ...
    prompt = f"""你是 Andrej Karpathy 风格的技术信息策展人。信噪比优先，只保留真正有价值的内容。
今天的新文章：
{article_list}
请整理成：
📡 _每日技术雷达_ | {datetime.now().strftime('%Y.%m.%d')}
按分类列出，每条：- [来源] 标题 → 一句洞见 + 链接
最后：🔭 _今日必读_：最值得深读的一篇
600字以内，中文。"""
    r = requests.post(
